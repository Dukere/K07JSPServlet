...
<%
/* 
모든 영역(페이지, 리퀘스트, 세션, 어플리케이션)에는 모든 타입의 객체를
저장할 수 있다. Object타입으로 자동 형변환되어 저장되고, 사용 시에는
...
<body>
	...
	<%
	/*  
	page영역에 저장될 때 object 타입으로 자동형변환되어 저장되므로
	...
	*/
	...
	<%--
		페이지영역에 저장된 속성값은 새로운 페이지에 대한 요청이 발생하면
	...
	<br />
	<%--
		외부파일을 인클루드 하는 경우 외부문서는 원본 그대로 현재문서에
		포함된 후 컴파일되므로 include 지시어를 사용하는 경우
