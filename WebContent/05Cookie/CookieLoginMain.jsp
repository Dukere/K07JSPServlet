...
String user = "";
//쿠키가 존재한다면 전체에서 URER_ID라는 쿠키명이 있는지 찾는다.
if(cookies!=null){
...
%>
   ...
   <!-- 
      input태그의 tabindex속성
      : 포커스 이동을 위해 탭(Tab)키를 눌렀을떄 포커스가 이동하는
   ...
   <table border="1">
      <tr>
         ...
         <td>
            ...
            <!-- 변수 user에 저장된 값이 있을떄 checkbox의 checked속성을 
            활성화한다.  -->
...
%>
   <table border="1" width=400>
      <tr>
         <td align="center">
         <!-- 세션영역에 저장된 속성이 있으므로 getAttribute로 읽어올수있다. -->
