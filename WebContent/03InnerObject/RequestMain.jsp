...
<body>
	...
	%>
	<a href="RequestParameter.jsp?name=<%=encodeName%>&id=hong&
		sex=man&favorite=&self_intro=">Get방식</a>
	<br />
	<br />
	<script>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		<br />
		자기소개 :
		<textarea name="self_intro" cols="30" rows="10">설왕설래</textarea>
		<br />
		<input type="submit" value="POST방식" />
	</form>
	...
	<div style="font-size:14px; color:blue;">
		<ol>
			<li>RequestHeader 자체실행 : referer항목 보이지 않음.</li>
