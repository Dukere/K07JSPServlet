...
<body>
	...
	폼값을 받을 수 있다. 만약 값이 입력되지 않았다면 길이가 0인 String객체를
	...
	*/
	...
	항목은 여러개이나, 실제 선택가능한 항목이 하나이기 때문이다.
	*/
	//방법1 : text타입과 동일한 형태로 폼값을 받을 때 . . . 
	//String sexStr = request.getParameter("sex");
	//방법2 : checkbox처럼 배열형태로 폼값을 받을 떄 . . .  . .
	...
	여러 개의 항목 중 체크가 된 항목만 전송된다. 파라미터명이 틀리거나 값이 전송되지 않으면
	null을 반환한다.
	*/
	...
	웹브라우저에 출력할 때는 특수기호를 <br>태그로 변환 후 출력해야한다.
	*/
	String self_intro
